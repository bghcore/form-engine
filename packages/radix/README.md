> **DEPRECATED:** This package has been renamed to [`@formosaic/radix`](https://www.npmjs.com/package/@formosaic/radix). Please install `@formosaic/radix` instead. This package will no longer receive updates.
>
